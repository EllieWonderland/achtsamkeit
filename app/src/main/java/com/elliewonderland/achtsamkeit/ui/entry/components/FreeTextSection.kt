...
@Composable
fun FreeTextSection(value: String, onValueChange: (String) -> Unit) {
    SectionCard(title = "Weitere Gedanken (optional)") {
        OutlinedTextField(
            value         = value,
            onValueChange = onValueChange,
            modifier      = Modifier.fillMaxWidth(),
            placeholder   = { Text("Was beschäftigt dich noch?", color = AppTheme.colors.inkSoft) },
            minLines      = 3,
